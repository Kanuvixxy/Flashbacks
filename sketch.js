...
function setup() {
  ...
  //create group for robo spawnning
  roboBossGroup = new Group();
}
...
function draw() {
  ...
  if (gameState === 1) {
    ...
    if (keyDown("d")) {
      ...
      player.x = player.x - 5;
    } else if (keyDown("space") && player.y >= windowHeight / 2 + 320) {
      player.velocityY = -18;
      jumpSound.play();
    }
  ...
  if (gameState === 4) {
    ...
    if (keyDown("d")) {
      ...
      player.x = player.x - 5;
    } else if (keyDown("space") && player.y >= windowHeight / 2 + 255) {
      player.velocityY = -20;
      jumpSound.play();
    }
  ...
  if (gameState === 6) {
    ...
    if (keyDown("d")) {
      ...
      player.x = player.x - 7;
    } else if (keyDown("space") && player.y >= windowHeight / 2 + 256) {
  ...
  if (gameState === 8) {
    ...
    if (keyDown("d")) {
      ...
      player.x = player.x - 7;
    } else if (keyDown("space") && player.y >= windowHeight / 2 + 205) {
      player.velocityY = -22;
      jumpSound.play();
    }
    ...
    if (player.collide(time4)) {
      ...
      part_count = part_count - 1;
      partSound.play();
      time4Puzzle = createSprite(windowWidth / 3 + 450, );
    }
